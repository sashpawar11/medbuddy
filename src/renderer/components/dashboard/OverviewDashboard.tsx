        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2.5">
            <span className="text-body font-semibold text-primary dark:text-ink-100 truncate max-w-[280px]">
              {analysis.scope_name || 'General Records'}
            </span>
        ...
        <div className="max-w-[1440px] w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-5 items-stretch">
              {/* Left: Narrative Card */}
              <div className="md:col-span-7 lg:col-span-8 bg-surface dark:bg-ink-900 rounded-xl border border-border dark:border-ink-800 p-6 shadow-xs flex flex-col justify-between">
                <div>
              ...
              <div
                className={`md:col-span-5 lg:col-span-4 rounded-xl border p-6 flex flex-col justify-between shadow-xs ${
                  totalFlaggedCount > 0
              ...
              >
                ...
                {totalFlaggedCount > 0 && (
                  <div className="mt-4 pt-3 border-t border-amber-200 dark:border-amber-800/60 text-caption font-medium text-amber-800 dark:text-amber-300 flex items-center gap-1.5">
            ...
            {result.discussionPoints && result.discussionPoints.length > 0 ? (
                    ...
                    >
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-2">
                        ...
                        <button
                          ...
                          className="px-2.5 py-1 rounded-md text-caption font-medium text-tertiary dark:text-ink-400 hover:text-primary dark:hover:text-ink-100 hover:bg-surface-hover dark:hover:bg-ink-800 border border-border dark:border-ink-800 flex items-center gap-1 transition-colors"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                {result.recommendations.map((rec, i) => (
                  <div
                    key={i}
                    className="bg-surface dark:bg-ink-900 rounded-xl border border-border dark:border-ink-800 p-4 shadow-xs"
                  >
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {result.anomalies.map((anom, i) => (
                  <div
                    key={i}
                    className="p-5 rounded-xl bg-surface dark:bg-ink-900 border border-border dark:border-ink-800 shadow-xs space-y-3"
                  >
          ...
          {trendableMetrics.length > 0 && (
            <div className="bg-surface dark:bg-ink-900 rounded-xl border border-border dark:border-ink-800 p-6 shadow-xs space-y-5">
              <div className="flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                {trendableMetrics.map((tm, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="p-4 rounded-lg bg-surface-recessed dark:bg-ink-800/60 border border-border dark:border-ink-800 space-y-2.5"
                    >
          ...
          {analysis.source_documents && analysis.source_documents.length > 0 && (
            <div className="bg-surface dark:bg-ink-900 rounded-xl border border-border dark:border-ink-800 p-5 shadow-xs space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {analysis.source_documents.map((sd) => {
                  ...
                  return (
                    <div
                      key={sd.id}
                      className="p-3.5 rounded-lg bg-surface-recessed dark:bg-ink-800/60 border border-border dark:border-ink-800 flex items-center justify-between gap-3 hover:border-border-strong dark:hover:border-ink-700 transition-colors"
                    >
                      ...
                      {onPreviewDoc && (
                        <button
                          ...
                          className="px-2.5 py-1 rounded-md text-caption font-semibold text-vault-600 dark:text-vault-400 hover:bg-vault-50 dark:hover:bg-vault-950/50 flex items-center gap-1 shrink-0 transition-colors"
                        >
                          <span>View</span>
